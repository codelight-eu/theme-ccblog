...
<ul class="{{ $class }}">
  <li class="article_socialItem inline-block">
    <a href="{{ $fbShareLink }}" target="_blank" class="article_socialLink"><i class="icon-facebook-outline-charcoal icon--small"></i></a>
  </li>
  <li class="article_socialItem inline-block">
    <a href="{{ $twitterShareLink }}" target="_blank" class="article_socialLink"><i class="icon-twitter-outline-charcoal icon--small"></i></a>
  </li>
  <li class="article_socialItem inline-block">
    <a href="{{ $emailShareLink }}" class="article_socialLink"><i class="icon-envelope-charcoal icon--small"></i></a>
  </li>
</ul>
